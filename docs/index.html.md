...
```
    ...
    33 *** pointing group of 7 in row 0 to block 1: removed candidate 7 from cell [2, 4]
    34 *** pointing group of 7 in row 0 to block 1: removed candidate 7 from cell [2, 5]
...
```
    ...
    21 *** column 0: filled cell [5, 0] with value 9
    22 *** column 1: filled cell [0, 1] with value 9
    23 *** naked group of {9, 7} in block 7: removed candidates {9} from cell [7, 4]
    24 *** naked group of {9, 7} in block 7: removed candidates {7} from cell [6, 3]
    25 *** naked group of {9, 7} in block 7: removed candidates {9} from cell [7, 5]
    26 *** naked group of {9, 7} in block 7: removed candidates {7} from cell [6, 4]
    27 *** naked group of {9, 7} in block 7: removed candidates {7} from cell [6, 5]
    28 *** pointing group of 9 in block 4 to column 4: removed candidate 9 from cell [8, 4]
    29 *** pointing group of 7 in block 5 to column 8: removed candidate 7 from cell [0, 8]
    30 *** pointing group of 7 in block 5 to column 8: removed candidate 7 from cell [2, 8]
    31 *** pointing group of 7 in block 5 to column 8: removed candidate 7 from cell [6, 8]
    32 *** pointing group of 7 in row 0 to block 1: removed candidate 7 from cell [2, 5]
    33 *** pointing group of 7 in row 0 to block 1: removed candidate 7 from cell [2, 4]
